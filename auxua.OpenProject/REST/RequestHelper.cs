...
namespace auxua.OpenProject.REST
{
    internal static class RequestHelper
    {
        ...
        internal async static Task<string> PatchStringAsync(string url, string content, HttpClient _http, IAuthProvider? _auth, bool exceptionOnError = true)
        {
        ...
        internal async static Task DeleteNoContentAsync(string url, HttpClient _http, IAuthProvider? _auth, bool exceptionOnError = true)
        {
